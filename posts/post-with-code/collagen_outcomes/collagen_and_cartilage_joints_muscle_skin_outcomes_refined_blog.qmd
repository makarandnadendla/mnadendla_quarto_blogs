...
# initiate a tibble to be used in a meta analysis for SMD with continuous outcomes
#silly_sports_smd_meta_df <- as.tibble(read.csv(here("posts", "posts-with-code", "collagen_outcomes", "silly_smd_muscle_meta.csv")))

#silly_sports_smd_meta <- 
#forest(silly_sports_smd_meta)
```
...
-   The forest plots at least do a good job of separating time points and other things into relevant subgroup analyses. Though I think they probably fiddled around too much and need to limit the scope of their analysis….but that’s probably a more mild criticism in today’s climate of meta analyses. 🙃
...
-   Yet another [study](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC8707759/) from this meta that didn’t protein match in the placebo nor give baseline protein intakes. They also didn’t use ANCOVA, or change scores even to analyze. Plus significance testing variables at baseline…..noobs ![](https://lh7-rt.googleusercontent.com/docsz/AD_4nXfRod5Jk9p4b2IQFeGogaygJ8lKIvMtmh47dkF_rf1-XmpZOaMsp9Co-7tjIFa5neXK17OgIGR_eHl9fPqJWn2FUGSBLODcC7DFfOvJKJxgZ8T8OGVVgbBIc9POfbKuEAtsYBPzrRnpCkxR9BtQfaVNxgw?key=rf44RV7tAsqSBFC_Mo--og)
...
Overall if there’s a possible benefit to be had from collagen, the strongest evidence is in skin it seems. But there are still some But I’m not as equipped to evaluate inclusion criteria in these studies, as well as knowing what clinical significance is for a lot of these metrics. I’ll do best consulting a researcher that is more familiar with skin.
